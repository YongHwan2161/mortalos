...
export class IndexedDbCounterAuthority {
  ...
  constructor(authority, store, privateKey) {
    this.#authority = authority;
    this.#keyPolicy = Object.freeze({
      extractable: privateKey.extractable,
      type: privateKey.type,
      usages: Object.freeze([...privateKey.usages])
    });
    this.#store = store;
  }
  ...
  static async open({ databaseName = DATABASE } = {}) {
    ...
    return new IndexedDbCounterAuthority(authority, store, material.privateKey);
  }

  get descriptor() {
    return this.#authority.descriptor;
  }
  ...
  reserveRange(input) {
    return this.#authority.reserveRange(input);
  }

  inspect(epochId) {
    return this.#authority.inspect(epochId);
  }

  retire(epochId) {
    return this.#authority.retire(epochId);
  }
