...
test("corruption and inconsistent migration substitutions fail closed", async () => {
  for (const [path, value] of [
...
test("expiry latch, rollback, renewal, and removal substitutions fail closed", async () => {
  for (const [path, value] of [
...
test("validation interval and environment substitutions fail closed", async () => {
  for (const [path, value] of [
    [["source_committed_at"], "2026-07-25T15:00:58.000Z"],
    [["completed_at"], "2026-07-25T15:00:56.000Z"],
