...
const EXPECTED_SOURCE_COMMIT = "2ef4ea9e55e6d8ebfc1934dd38a663cb0befda90";
...
const EXPECTED_SCHEMA_DIGEST =
  "sha256:6b7363f0f01aca1a85f96c66f3522b03d16f5decffe2a7327eb9fb2910e362a3";
const EXPECTED_TEST_DIGEST =
  "sha256:4583921406af07f21213535cfd0fa39c65007a93977639b2240b89dc734df30d";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.migration, {
    valid_v1_to_v2: "PASS",
    successful_store_names: ["participant"],
    legacy_stores_removed_on_success: "PASS",
    empty_v1_document_absent: true,
    empty_v1_store_names: ["participant"],
    empty_v1_legacy_stores_removed: "PASS",
    removal_status: "removed",
    participant_key_absent_after_removal: true,
    legacy_key_absent_after_removal: true,
    legacy_raw_signing_after_removal: false,
  ...
  assert.deepEqual(receipt.results.authority_policy, {
    ...
    null_renewal_rejected: "PASS",
    stale_or_equal_renewal_rejected: "PASS",
    status_after_rejected_renewals: "expired",
