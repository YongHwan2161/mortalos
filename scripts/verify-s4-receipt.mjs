...
const EXPECTED_RECEIPT_DIGEST =
  "sha256:e7f4cad9711cec08fddcbf5fcbe50e8e74f54f2fd0136533cb89ad84f0cbe9b9";
const EXPECTED_SOURCE_COMMIT = "5a59da1b9ac704a56c2de72844dfa6197fc2ea0a";
...
const EXPECTED_TEST_DIGEST =
  "sha256:4766ef2bd5d197049a8f516674d492db8e6e724ef6fd22facca7bdf4189db21e";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.coverage_percent, {
    repository: { lines: 95.39, branches: 91.93, functions: 94.92 },
    counter: { lines: 94.85, branches: 94.57, functions: 80.49 },
