...
const EXPECTED_RECEIPT_DIGEST =
  "sha256:02e933be0862cdf4de5458d391913abebf25456ebf367f656e57d3198d3acf18";
const EXPECTED_SOURCE_COMMIT = "175a92ed19948e3d39e58c5c33c452c2354bf202";
...
const EXPECTED_SCHEMA_DIGEST =
  "sha256:fb61c1fca72ccb2083299426ab44e201ba7fad3646d04228cda9dd8453f7c14e";
const EXPECTED_TEST_DIGEST =
  "sha256:023989a93a4ea01b6791d9b2f1085db988b72449605baa9dcd1a1d79fe778221";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.confidential_tests, { passed: 20, failed: 0 });
  ...
  assert.deepEqual(receipt.results.coverage_percent, {
    repository: { lines: 96.15, branches: 92.22, functions: 96.77 },
    counter: { lines: 97.6, branches: 95.05, functions: 100 },
    format: { lines: 96.4, branches: 90.57, functions: 100 },
    keys: { lines: 97.81, branches: 93.88, functions: 100 },
    package: { lines: 94.69, branches: 87.5, functions: 100 },
    recovery: { lines: 97.84, branches: 87.18, functions: 100 }
  });
