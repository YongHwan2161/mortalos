...
const EXPECTED_RECEIPT_DIGEST =
  "sha256:e3ea2848640d394b84441c87be5d4df7c6e9dfe623549d825caf48d1d02f25a8";
const EXPECTED_SOURCE_COMMIT = "f9cbebf7cb2955d9e522827be7743bc0beaac872";
...
const EXPECTED_SCHEMA_DIGEST =
  "sha256:77fb15b4cb272cbfb8dab0e4ec7caf039d4329e5969e3653c62cc8a8d1d790a3";
const EXPECTED_TEST_DIGEST =
  "sha256:92efa0e4cac8bebde80cbe7c9f3e38a136e3e52e88d8cf2a0dec95cb4c991e24";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.confidential_tests, { passed: 23, failed: 0 });
  ...
  assert.deepEqual(receipt.results.browser_counter_authority, {
    ...
    private_record_branded: true,
    store_capability_private_record: true,
    own_method_replacement_rejected: true,
    prototype_method_replacement_ignored: true,
    retirement_persisted: true,
    post_retirement_reservation_rejected: true,
    lost_rotation_completed: true,
    equivocation_rotation_completed: true,
    old_authority_blocked_after_equivocation: true,
  ...
  assert.deepEqual(receipt.results.membership_and_rotation, {
    ...
    subclass_authority_rejected: true,
    proxy_authority_rejected: true,
    public_method_override_ignored: true,
    persistent_facade_rotation_supported: true,
  ...
  assert.deepEqual(receipt.results.coverage_percent, {
    repository: { lines: 95.6, branches: 91.66, functions: 95.29 },
    counter: { lines: 94.25, branches: 93.53, functions: 83.67 },
    format: { lines: 96.46, branches: 90.57, functions: 100 },
    keys: { lines: 97.81, branches: 93.88, functions: 100 },
    package: { lines: 93.65, branches: 86.54, functions: 100 },
    recovery: { lines: 89.98, branches: 87.37, functions: 100 }
  });
