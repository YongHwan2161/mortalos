...
const EXPECTED_RECEIPT_DIGEST =
  "sha256:e34263f082df419f433e8521dabb03206dcc69b67416a80f30bd94b6549e9d84";
const EXPECTED_SOURCE_COMMIT = "fcc98ec8246d5c01876fc9c5bc1fd36b28ffc9c1";
...
const EXPECTED_SCHEMA_DIGEST =
  "sha256:d6423d764a453e36351b7728b560ced791679fa882f5c85218a794e432e54476";
const EXPECTED_TEST_DIGEST =
  "sha256:1dce245405f844b6ee2646ea300d8bb1913320a4313e5e2865afad4bfa326650";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.confidential_tests, { passed: 22, failed: 0 });
  ...
  assert.deepEqual(receipt.results.coverage_percent, {
    repository: { lines: 95.33, branches: 91.82, functions: 95.02 },
    ...
    package: { lines: 94.48, branches: 86.75, functions: 100 },
    recovery: { lines: 89.86, branches: 85.26, functions: 100 }
  });
