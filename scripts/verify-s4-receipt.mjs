...
const EXPECTED_RECEIPT_DIGEST =
  "sha256:baa1f7bad6fa5d50295437848948a5f7848a3a3f8c8af898da74579a6a82687e";
const EXPECTED_SOURCE_COMMIT = "5655db34880fb29fcad9e1a9d2d01ec046d8cf24";
...
const EXPECTED_TEST_DIGEST =
  "sha256:a058858cc57eabfb8a5658b3fdfa5762a3c45522ae6a1d9ce21ffcac231fc1dc";
...
function assertSemanticEvidence(receipt) {
  ...
  assert.deepEqual(receipt.results.coverage_percent, {
    repository: { lines: 95.3, branches: 91.91, functions: 94.53 },
    counter: { lines: 94, branches: 93.43, functions: 79.59 },
    ...
    recovery: { lines: 88.77, branches: 84.95, functions: 100 }
  });
