...
4. for authority loss or equivocation, a fresh strict Ed25519 counter-authority key
   and ID. Loss requires an actual bound authority instance whose authoritative
   epoch state is inaccessible. Equivocation requires runtime-branded jointly
   observed evidence and the actual bound authority already retired. For
