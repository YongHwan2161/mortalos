...
| S5 SDK/CLI public boundary | `sdk/index.mjs`, `sdk/continuity.mjs`, `cli/mortalos.mjs`, `cli/node-authority.mjs`, `test/sdk.test.mjs`, `scripts/verify-sdk-package.mjs` | Default authority-free export allowlist; explicit create/inspect/handoff/recover/continue capability API; clean packed consumer completes the real-file CLI flow without repository-relative imports; exchanged artifacts contain no private key |
