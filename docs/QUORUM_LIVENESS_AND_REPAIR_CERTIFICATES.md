...
Status: **EXACT-MAIN SOURCE/RUNTIME/TEST/RELEASE PASS AT `a6cfb657…`; EXTERNAL ISSUER HONESTY/INDEPENDENCE HOLD**
...
| `npm test` | PASS from `2026-08-21T15:08:09.9777152+09:00` through `2026-08-21T17:12:46.1993423+09:00`, exit `0`, wall `7,476,222ms`, through final `verify:s4`. Exact-main Verify `33052134872/1` is the publication authority for `a6cfb657…`; later changes require fresh gates. |
