...
상태: **ACTIVE EXECUTION SSOT — S0–S10 LOCAL PASS; S11 진행 중; S12 review/merge/production acceptance 대기**  
...
| `npm run test:relay` | DO persistence, TTL, limits, restart, malicious message cases |
| `npm run test:multi-browser` | A→B handoff와 A/B/C quorum Playwright profiles |
