...
Status: **ACTIVE — SIGNED RESOURCE CONTRACT CANDIDATE, PROMOTION PENDING**
...
| Signed bounded resource offer and lease | Candidate in this branch | Canonical provider offer, mutual single-use lease, jointly signed chained usage, unilateral revocation, equivocation halt, generated limits, browser-target bundle, portable scan, and clean packed consumer pass locally | No | No | This proves finite signed intent and accounting evidence, not resource possession, truthful metering, service delivery, settlement, Sybil resistance, or independent providers. |
