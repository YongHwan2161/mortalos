...
|---|---:|---|---|
| `@cloudflare/vitest-pool-workers` | 0.20.1 | Development-only Durable Object runtime verification | MIT |
...
| `wrangler` | 4.118.0 | Development-only Cloudflare Worker/Pages deployment and dry-run bundling | MIT OR Apache-2.0 |
