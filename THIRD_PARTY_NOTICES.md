...
The deployable static Lab includes [`lab/THIRD_PARTY_LICENSES.txt`](lab/THIRD_PARTY_LICENSES.txt), containing the complete copyright and MIT permission text for both bundled Noble packages.
