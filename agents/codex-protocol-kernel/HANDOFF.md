...
- Work branch: `agent/codex-protocol-kernel--s4-authority-boundary-v2`
- Worktree: `C:/Users/ant71/Documents/Codex/2026-07-17/yonghwan2161-mortalos-git-https-github-com/work/mortalos-worktrees/codex-protocol-kernel--s4-authority-boundary-v2`
...
- Independent review of replacement PR #46 at immutable head
  `a16e2326a0bfda21660cf02bbca770f8c9108884` also returned **BLOCK** in
  review `4782830849`. A subclass could override public authority methods to fake
  loss or avoid real retirement, while the production IndexedDB wrapper could not
  pass the same `instanceof` gate. That head and receipt are invalid. The current
  remediation uses an exact-constructor authority and a frozen persistent facade
  bound to a module-private WeakMap record; trust decisions call only direct
  record-backed descriptor, inspect, reserve, and retire operations. A new
  direct-base source, receipt promotion, PR, and independent review are mandatory.
